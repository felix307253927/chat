...
function send() {
  ...
  if (text) {
    ...
    xhr.open('get', 'http://117.121.49.45:9001/service/iss?text=' + text + '&appkey=hjppipl5dhydtfo6bhlec7ysri2gmgbog5dvlmqa&ver=2.0&udid=JUnit-test393931&appsig=8FE5E15BF5C2C92D7C0B707DF92D6440F6154F16&appver=&city=&history=&time=2014-05-13+15%3A31%3A07&voiceid=&gps=&method=iss.getTalk&dpi=', true)
...
addText('您好，欢迎使用云知声智能客服，请问有什么可以帮您？')
